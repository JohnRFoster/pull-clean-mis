...
def single(cursor):
    ...
    SELECT 
        ...
        -- Property information (from old "Property" table)
    ...
    FROM M2_WORK_TASK
        ...
        -- Property information (ensures we have property data like old queries)
        ...
        -- Work task UOM (from old Effort table)
    ...
    -- Conflict work and damage agent (from old Effort table approach)
